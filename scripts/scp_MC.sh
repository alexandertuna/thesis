...
# vbf
input="atuna@at3i00.hep.upenn.edu:/web/Analysis/tuna/HiggsTauTau2012/scratch/higgs.plots.2014-12-09-16h52m17s/regions/VBFmvaSR/*/*"
output="figures/analysis/vbf-MCXSR"
