...
\begin{figure}[tp]
  ...
  \caption{Aerial view of Geneva with an overlaid drawing of the LHC and associated experiments.}
...
\begin{figure}[tp]
  ...
  \caption{The LHC accelerator complex. Before reaching the LHC, protons are accelerated at Linac 2, the Proton Synchrotron Booster (PSB), the Proton Synchrotron (PS), and the Super Proton Synchrotron (SPS).}
...
\begin{figure}[tp]
  ...
  \caption{Cross sections for $pp$ and $p\overline{p}$ processes in the center-of-mass energy regime relevant to the Tevatron and LHC, courtesy of W.J. Stirling~\cite{2013.stirling}.}
...
\begin{figure}[tp]
  ...
  \caption{Scale rendering of the ATLAS detector with the various sub-detectors highlighted.}
...
\begin{figure}[tp]
  ...
  \caption{The peak ATLAS online luminosity as measured in different data-taking periods. The peak Run-I luminosity is $0.8\times 10^{34} \text{cm}^{-2} \text{s}^{-1}$.}
...
\begin{figure}[tp]
  ...
  \caption{Distributions of the recorded luminosity in bins of $\pileup$ (left) and the total integrated luminosity as a function of time (right). In 2011 (2012), the average $\pileup$ is 9.1 (20.7) and the total integrated luminosity for physics analysis is 4.6 $\ifb$. (20.3 $\ifb$).}
...
\begin{figure}[tp]
  ...
  \caption{Summary of cross sections measured at ATLAS in 7 and 8 TeV data-taking.}
...
\begin{figure}[tp]
  ...
  \caption{Schematic view of the calorimeter granularity available at the L1 trigger.}
